 ...
 */
final class Version20210930051156 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE heberge (id INT AUTO_INCREMENT NOT NULL, numcli_id INT NOT NULL, numchambre_id INT NOT NULL, nbjours VARCHAR(255) NOT NULL, compagne VARCHAR(255) NOT NULL, montant VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, payement VARCHAR(255) NOT NULL, dateentre DATETIME NOT NULL, datesortie DATETIME NOT NULL, INDEX IDX_D217B48071F5BF5A (numcli_id), INDEX IDX_D217B480A455AA95 (numchambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
